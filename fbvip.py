    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://youtu.be/jiAjOsnVs6o')
                time.sleep(2)
                menu()
